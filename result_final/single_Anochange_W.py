...
from server import adaptive_sample,Weight_Computation1,Weight_Computation,change_all
...
def TimeAllocate():
    ...
    for ti in range(79):        #先考虑有20个时间戳
        ...
        #scale,tilast,objectaita,adaptive_user=change_all(tilast,ti,scale,w,epsionolist,adaptive_user)
