...
from estimation import MAE,MAPE2,MAE2
...
def TimeAllocate():
    ...
    for ti in range(79):        #先考虑有20个时间戳
        ...
        scale,tilast,objectaita,adaptive_user=adaptive_sample(tilast,ti,scale,w,epsionolist,adaptive_user)          #objectaita好像没用到
...
def initial(maxepsiono,A,B):
    ...
    epsiono2 = random.uniform((A/B)*maxepsiono-0.0067,(A/B)*maxepsiono-0.0025)     #这里的范围也需要进一步确定
